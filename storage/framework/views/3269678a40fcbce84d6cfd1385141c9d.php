...
<head>
    ...
    <!-- ===== CSS ===== -->
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/homestyle.css')); ?>">
    ...
    <nav class="nav bd-grid">
        ...
        <div class="nav__menu" id="nav-menu">
            <ul class="nav__list">
                ...
                <li class="nav__item"><a href="#about" class="nav__link">Blog</a></li>
                <li class="nav__item"><a href="<?php echo e(route('portfolio.index')); ?>" class="nav__link">Portfolio</a></li>
...
<footer class="footer section">
    <div class="footer__container bd-grid">
        <div class="footer__data">
            <h2 class="footer__title">Mahdi Malekifard</h2>
            <p class="footer__text">I'm Mahdi Malekifard and this is my personal website</p>
        </div>
...
<?php /**PATH D:\PROJECTS\portfolio\resources\views/web/home/index.blade.php ENDPATH**/ ?>