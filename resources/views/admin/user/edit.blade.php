                        ...
                        <div class="account-settings">
                            <div class="user-profile">
                                <div class="user-avatar">
                                    @if($user->image)
                                        <img src="{{ Storage::url($user->image->url) }}" alt="{{ $user->image->name }}">
                                    @endif
                                </div>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        <div class="row gutters">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="form-group">
                                    <label for="website">National Code</label>
                                    <input type="url" class="form-control" id="website" name="national_code"
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="name" class="form-control" id="ciTy" name="city"
                                           value="{{ $user->profile->address->city->name }}">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="country" name="country"
                                           value="{{ $user->profile->address->city->country->name }}">
                                </div>
                            </div>
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="zIp" name="zip_code"
                                           value="{{ $user->profile->address->zip_code }}">
                                </div>
                            </div>
                        </div>
                        <div class="row gutters">
